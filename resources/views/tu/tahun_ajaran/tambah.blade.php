...
<div class="d-flex align-items-center mb-4 gap-3">
    ...
    <div>
        <h3 class="fw-bolder text-dark mb-0" style="letter-spacing: -0.5px;">Tambah Tahun Ajaran Baru</h3>
        <p class="text-secondary mb-0" style="font-size: 0.9rem;">Buat periode akademik baru untuk sistem penilaian.</p>
    </div>
</div>
...
<div class="card border-0 rounded-4 bg-white mb-5" style="box-shadow: 0 4px 24px rgba(0,0,0,0.03); border: 1px solid #e2e8f0 !important; max-width: 800px;">
    <div class="card-body p-4 p-md-5">
        <form action="{{ route('tu.tahun-ajaran.store') }}" method="POST">
            @csrf
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <h5 class="fw-bold text-dark mb-0">Detail Periode Akademik</h5>
            </div>
            ...
            <div class="row g-4 mb-2">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="tahun" class="form-control form-control-lg bg-light fs-6 border-light shadow-none focus-ring-primary fw-bold text-dark" placeholder="Contoh: 2026/2027" value="{{ old('tahun') }}" required>
                    <small class="text-muted mt-2 d-block" style="font-size: 0.8rem;">
                        <i class="bi bi-info-circle-fill text-primary opacity-75 me-1"></i> 
                        Format penulisan bebas, namun disarankan menggunakan garis miring (/).
                    </small>
                </div>
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-end gap-2 pt-4 border-top border-light mt-5">
                <a href="{{ route('tu.tahun-ajaran.index') }}" class="btn btn-light border px-4 py-2 fw-semibold text-secondary rounded-pill hover-btn-back">Batal</a>
