...
class RiwayatTransaksiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('bendahara.laporan.riwayat', compact('riwayats', 'judulRekap', 'totalRekap'));
    }
    ...
    public function cetak($id)
    {
        ...
        // Kita return ke view khusus struk (tanpa sidebar dan navbar admin)
        return view('bendahara.laporan.struk', compact('trx'));
    }

    // FUNGSI BARU UNTUK EXCEL (Yang CSV Lama Sudah Dibuang)
    public function exportExcel(Request $request) 
    {
        return Excel::download(new PembayaranExport($request), 'Laporan_SPP_'.date('d-m-Y').'.xlsx');
    }
}